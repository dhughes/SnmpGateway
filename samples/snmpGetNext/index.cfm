...
<head>
	<title>Simple SNMP GetNext Test</title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
	<link href="../_common/css/examples.css" type="text/css" rel="stylesheet" />
</head>

<body>
	<h1>Simple SNMP GetNext</h1>
	<p>This is a simple example allows you to perform an SNMP getNext operation on a given SNMP agent.</p>
