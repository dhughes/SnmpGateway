...
<cffunction name="testGetResults">
  ...
  <cfset assertIsEmptyArray(actual) />
...
<cffunction name="testGetResultsAsStruct">
	...
	<cfset a_tests = actual["mxunit.tests.framework.MyCFCTest"]>
...
<cffunction name="testGetResultsAsStructMultipleComponents">
	...
	<cfset testSuite.addAll("mxunit.tests.framework.MyCFCTest")>
...
<cfscript>
 ...
 testSuite.addAll("mxunit.tests.framework.MyCFCTest");
