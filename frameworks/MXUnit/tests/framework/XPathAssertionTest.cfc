...
<cfcomponent  extends="mxunit.framework.TestCase">
 ...
 <cffunction name="testSSLUrl">
  ...
  <cffunction name="testIsWrapped">
    ...
    wrapped = isWrapped(adobe);
    //debug(wrapped);
    //debug(adobe);
    assertTrue(wrapped,"Should contain CDATA in script tag");
  ...
  <cffunction name="testBuildXmlDom">
	...
	<cffunction name="setUp" access="public" returntype="void">
      ...
      <cfhttp url="http://localhost:8500/mxunit-web/doc/tutorial/dir-runner.html">
      <cfset doc = cfhttp.FileContent />
