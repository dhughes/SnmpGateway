<cfcomponent extends="TestResult">
	...
	<cffunction name="addMethodNameJS" output="false" access="private" returntype="string">
		...
		<cfset link = "<a href='#fileURL#&method=runTestRemote&output=extjs'>#testStruct.testname#</a>">
	...
	<cffunction name="stripDump" output="false" returntype="string" access="private">
