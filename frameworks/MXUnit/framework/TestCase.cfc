...
<cffunction name="getTrace" returntype="string" access="public">
 <cfset retVal = duplicate(this.traceMessage) />
...
<cffunction name="getRunnableMethods" hint="Gets an array of all runnable test methods for this test case. This includes anything in its inheritance hierarchy" access="public" returntype="array">
	...
	<cfif NOT cu.isFrameworkTemplate(ThisComponentMetadata.Extends.Path)>
		...
		<cfloop from="1" to="#ArrayLen(a_parentMethods)#" index="i">
			...
			<cfif a_methods.indexOf(a_parentMethods[i]) LT 0>
...
<cffunction name="debug" access="public" returntype="void" hint="Use in your tests to add simple or complex debug data to test results. Used by Eclpise plugin heavily.">
